...
vrec 19_curlrc             "CURL_HOME=./curlhome curl -v -o /dev/null $T   # curlhome/.curlrc: proxy + proxy-user"           "CURL_HOME=./curlhome curl -sv -o /dev/null $T"
rm -rf curlhome
...
grep -q "exit=7" expected_output/20_*.txt || status=1
