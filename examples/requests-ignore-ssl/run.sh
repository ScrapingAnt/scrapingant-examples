...
g 01 "CERTIFICATE_VERIFY_FAILED"; g 02 ": 200"; g 02 "InsecureRequestWarning"; g 03 ": 200"
g 04 "s.get(URL): 200"; g 04 "verify=True): requests.exceptions.SSLError"
g 05 "verify='certs/localhost.pem'): 200"; g 05 "IP address mismatch"
g 06 "REQUESTS_CA_BUNDLE='certs/localhost.pem' python"; g 06 "requests.get(URL): 200"; g 06 "Could not find a suitable TLS CA certificate bundle"
...
grep -q "warning: InsecureRequestWarning" expected_output/03_*.txt && { echo "FAILED: 03 still warns"; status=1; }
