...
for n in 01 02 03 04 05 06 07 08 09 10 11 12; do g $n "exit=0"; done
...
g 09 "FileNotFoundError"; g 10 "DeprecationWarning"; g 11 "AttributeError"; g 11 "FeatureNotFound"; g 12 "lxml.html + xpath"
