...
for script in [0-9][0-9]*_*.py; do   # 01_…11_ plus 03b_
...
g 03 "httpx.Client x N"; g 03 "verify=ctx"; g 03b "certifi.where"; g 08 "load_cert_chain"; g 04 "pool is full"; g 04 "AsyncClient"; g 05 "http_version = HTTP/2"; g 05 "h2"; g 06 "peak RSS"
